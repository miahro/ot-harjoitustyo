...
class ResultServices:
    ...
    def add_result(self, user_id, task_id, result):
        ...
        person_id = userrepository.get_pk_id(user_id)[0] #vaatii poikkeuskäsittelyn
    ...
    def user_results_by_topic(self, user_id, topic):
        ...
        correct = resultrepository.get_user_correct_by_topic(person_id, topic_id)[0][0]
        fail = resultrepository.get_user_false_by_topic(person_id, topic_id)[0][0]
    ...
    def user_results_by_topic_all_topics(self, user_id):
      ...
      #  print(result_by_topic)
        return result_by_topic



# kesken, pitää tehdä jäkevä käsittely muotoon, joka voidaan palauttaa UI:lle näytettäväksi

...
class TestUser(unittest.TestCase):
    ...
    def test___repr__(self):
        self.assertEqual(self.test_student.__repr__(),
                         f"User(Tero, Testi, tt1, xx, False)")

    def test___str__(self):
        self.assertEqual(self.test_student.__str__(
        ), f"first_name: Tero, last_name: Testi, user_id: tt1, passwd: xx, teacher: False")
